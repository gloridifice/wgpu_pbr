...
binding_define! {
    ...
    2: frag  => csm_texture: TexView2DArray<SampleDepth>,
    3: frag  => csm_sampler: ComparisonSampler,
    4: frag  => dfg: TexView2D<SampleFloatFilterable>,
    5: frag  => skybox_texture: TexViewCube<SampleFloatFilterable>,
    6: frag  => skybox_sampler: FilteringSampler,
    7: frag  => skybox_sh_uniform: TypedBuffer<ComputedSHUniform>,
